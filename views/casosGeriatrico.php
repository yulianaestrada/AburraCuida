...
<body>
  <p>
    ...
    <center><h1>Casos de ayuda geriátrica</h1></center>
    ...
    $consulta = "SELECT * FROM casos1 WHERE edad = 'vejez' AND (tipocaso = 'fisica' OR tipocaso = 'sexual')";
    ...
    if (mysqli_num_rows($resultado) > 0) {
        ...
        while ($fila = mysqli_fetch_assoc($resultado)) {
            echo '<tr>
                    ...
                    <td>' . $fila['tipocaso'] . '</td>
                    <td>
                    <form method="get" action="verGeriatrico.php">
